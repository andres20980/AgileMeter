  ...
  ngOnInit() {
    $(document).ready(function(){
      ...
      $('.filterable .filters input').keyup(function(e){
          ...
          /* limpia resultados previos si existen */
          $table.find('tbody .no-result').remove();
          /* Muestra todas las filas, oculta las filtradas */
          $rows.show();
          $filteredRows.hide();
          /* antepone una fila sin resultado si todas las filas están filtradas*/
