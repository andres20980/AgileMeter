...
public static class Helper
{
    ...
    public static void emailBuilder(MimeMessage message, String user, String pass, String nombreCompleto)
    {
    ...
    <br>
    <p style='padding-left:20px;padding-right:20px'>Estamos encantados de que formes parte de nuestra familia y que te
